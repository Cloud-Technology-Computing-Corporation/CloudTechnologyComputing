...
<head>
    ...
    <!-- Title -->
    <title>Softconic- Software Agency and creative IT solution HTML Template</title>
                ...
                <div class="col-lg-8">
                    <div class="blog-details-content">
                        ...
                        <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh elementum, accumsan ona
                            ...
                            pellentesque quis magna eu vestibulum. Ut sed commodo neque. Morbi erat nisi, vehicula quis faucibus il aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque risus. Vivamus vehicula noted by thi
                        ...
                        <p>urna Aenean onewaryzo eleifend vitae tellus a facilisis. Nunc posuere at augue eget portat Inei odio tellus, dignissim fermentumara purus nec, consequat dapibus metus.Vivamus one urna worlda mauris, faucibus at egestas quis, fermentum egetonav neque.</p>
                        <div class="blog-tag-and-social">
                            <div class="tag">
                                ...
                                <ul>
                                    ...
                                    <li><a href="blog.html">Cyber</a></li>
                    ...
                    <div class="widget-area">
                        ...
                        <div class="single-widgets widget_egns_categoris">
                            ...
                            <ul class="wp-block-categoris-cloud">
                                <li> <a href="services/Web%20Development%20service-details.php" class="dropdown-item">Web Development services<span class="number-of-categoris">(1)</span></a></li>
                        <li><a href="services/Software%20Development%20service-details.php" class="nav-item nav-link">Software Development services<span class="number-of-categoris">(1)</span></a></li>
                        <li> <a href="services/Managed_Cloud_Hosting.php" class="dropdown-item">Managed Cloud Hosting<span class="number-of-categoris">(1)</span></a></li>
                           <li> <a href="services/S.E.O%20service-details.php" class="dropdown-item">S.E.O services<span class="number-of-categoris">(1)</span></a></li>
                           <li> <a href="services/Data%20Analytics%20service-details.php" class="dropdown-item">Data Analytics services<span class="number-of-categoris">(1)</span></a></li>
                           <li> <a href="services/Digital%20Marketing%20service-details.php" class="dropdown-item">Digital Marketing services<span class="number-of-categoris">(1)</span></a></li>
                           <li> <a href="services/Website%20Optimization%20service-details.php" class="dropdown-item">Website Optimization services<span class="number-of-categoris">(1)</span></a></li>
                           <li><a href="services/Mobile%20Development%20service-details.php" class="nav-item nav-link">Mobile Development services<span class="number-of-categoris">(1)</span></a></li>
                           <li> <a href="services/Wordpress%20Development%20service-details.php" class="dropdown-item">Wordpress Development services<span class="number-of-categoris">(1)</span></a></li>
                           <li> <a href="services/SAP%20Consulting%20service-details.php" class="dropdown-item">SAP Consulting services<span class="number-of-categoris">(3)</span></a></li>
                           <li> <a href="services/Consulting%20service-details.php" class="dropdown-item">Consulting services<span class="number-of-categoris">(3)</span></a></li>
                           <li> <a href="services/AI_Chatbot_Development.php" class="dropdown-item">AI Chatbot Development<span>UI/UX Design</span> <span class="number-of-categoris">(3)</span></a></li>
                            </ul>
                        </div>
