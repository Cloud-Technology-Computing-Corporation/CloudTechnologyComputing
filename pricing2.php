...
<body class="home-dark2 tt-magic-cursor">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    <a href="services.php" class="drop-down">services</a><i class="bi bi-plus dropdown-icon"></i>
                      <ul class="sub-menu">
                           <li> <a href="Software Development service-details.php" class="dropdown-item">Web Development services</a></li>
                        <li><a href="Software%20Development%20service-details.html" class="nav-item nav-link">Software Development services</a></li>
               ...
               <li><a href="case-study-standard.html">Case Studies</a></li>
   ...
   <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li> <a href="form.php" class="dropdown-item">Contact Us!</a></li>
       </ul>
            </ul>
                ...
                <form class="mobile-menu-form">
                    <div class="hotline pt-30">
                        ...
                        <div class="hotline-info">
                            ...
                            <h1><a href="tel:12389285567">1-248-938-5567</a></h1>
                        </div>
                    </div>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <div class="header-btn d-sm-flex d-none">
                <a href="../form.php">Free Consultation!</a>
            </div>
