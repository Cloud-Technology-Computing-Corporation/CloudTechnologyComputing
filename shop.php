...
<body class="home-dark2 tt-magic-cursor">
 ...
 <div class="banner-area4">
        <div class="background-text-slider">
            <h2 class="marquee_text">“If you can dream it, you can do it.” – Walt Disney</h2>
        </div>
<!-- Shop Banner -->
<section class="page-title">
    <div class="container">
        <h1 class="text-center mt-5">Our services Shop</h1>
        <p class="text-center mb-5">Choose from our range of digital services designed to scale your business.</p>
    </div>
</section>

<!-- Shop Products -->
<section class="service-listing py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Scalable AWS, Azure, and Google Cloud deployments tailored to your business needs.</p>
                        <a href="services/Cloud Solutions service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Boost your online presence and rank higher with expert search engine optimization.</p>
                        <a href="services/S.E.O service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Custom, responsive websites built from scratch to drive your brand forward.</p>
                        <a href="services/Web Development service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Full-cycle software solutions, from planning to deployment and maintenance.</p>
                        <a href="services/Software Development service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Leverage machine learning to automate, personalize, and innovate business processes.</p>
                        <a href="services/Artificial Intelligence service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h4 class="card-title">SAP Consulting</h4>
                        <p class="card-text">Optimize your business workflows and reporting with certified SAP experts.</p>
                        <a href="services/SAP Consulting service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Strategic technology guidance for digital transformation and infrastructure improvement.</p>
                        <a href="services/IT Consulting service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">iOS and Android mobile app solutions that deliver exceptional user experiences.</p>
                        <a href="services/Mobile Development service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Grow your audience with proven strategies in PPC, social media, and content marketing.</p>
                        <a href="services/Digital Marketing service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h4 class="card-title">Website Optimization</h4>
                        <p class="card-text">Speed, SEO, and UI/UX enhancements to keep your site lean, fast, and effective.</p>
                        <a href="services/Website Optimization service-details.php" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
